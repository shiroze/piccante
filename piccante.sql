...
-- Dumping data for table piccante.booking: ~0 rows (approximately)
...
-- Dumping data for table piccante.customers: ~0 rows (approximately)
...
-- Dumping data for table piccante.users: ~0 rows (approximately)
